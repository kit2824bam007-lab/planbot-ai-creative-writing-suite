...
export const LANGUAGES: PanelOption[] = [
  { value: 'en', label: 'English' },
  { value: 'ta', label: 'தமிழ் (Tamil)' },
];

// 2. GENRES (Story mode - expansive choices)
export const GENRES: PanelOption[] = [
...
export const TAMIL_CLASSICAL_FORMS = [
  'வெண்பா',
  'குறிஞ்சி',
  'முல்லை',
  'மருதம்',
...
export const POEM_TYPES: PanelOption[] = [
  // Western Poetry
...
export const LENGTHS: PanelOption[] = [
...
export const STORY_LENGTHS: PanelOption[] = [
...
export const PLATFORMS: PanelOption[] = [
...
export const STYLES: PanelOption[] = [
...
export const FORMATS: PanelOption[] = [
